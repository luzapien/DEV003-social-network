...
const Home = () => {
  ...
  signOutBtn.innerText = "Cerrar sesi\xF3n";
...
const Register = () => {
  ...
  form.append(name2, lastname, email, password, passwordConfirm);
...
function onNavigate(pathname) {
  ...
  if (localPath.includes("/DEV003-social-network/")) {
    path = localPath + pathname.replace("/", "");
  }
